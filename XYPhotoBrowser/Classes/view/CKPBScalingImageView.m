...
@interface CKPBScalingImageView ()
...
@implementation CKPBScalingImageView
...
#pragma mark - CKPBScalingImageView
...
- (void)updateImage:(UIImage *)image imageData:(NSData *)imageData {
    ...
    if (imageData != nil) {
        NSLog(@"[CKPhotoBrowserViewer] Warning! You're providing imageData for a photo, but CKPhotoBrowserViewer was compiled without animated GIF support. You should use native UIImages for non-animated photos. See the CKPhotoBrowserItem protocol documentation for discussion.");
    }
