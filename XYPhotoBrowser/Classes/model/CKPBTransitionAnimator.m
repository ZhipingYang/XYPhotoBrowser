...
static const CGFloat CKPBTransitionAnimatorDurationWithZooming = 0.5;
static const CGFloat CKPBTransitionAnimatorDurationWithoutZooming = 0.3;
static const CGFloat CKPBTransitionAnimatorBackgroundFadeDurationRatio = 4.0 / 9.0;
static const CGFloat CKPBTransitionAnimatorEndingViewFadeInDurationRatio = 0.1;
static const CGFloat CKPBTransitionAnimatorStartingViewFadeOutDurationRatio = 0.05;
static const CGFloat CKPBTransitionAnimatorSpringDamping = 0.9;

@interface CKPBTransitionAnimator ()

@property (nonatomic, readonly) BOOL shouldPerformZoomingAnimation;

@end

@implementation CKPBTransitionAnimator
...
- (instancetype)init {
    ...
    if (self) {
        _animationDurationWithZooming = CKPBTransitionAnimatorDurationWithZooming;
        _animationDurationWithoutZooming = CKPBTransitionAnimatorDurationWithoutZooming;
        _animationDurationFadeRatio = CKPBTransitionAnimatorBackgroundFadeDurationRatio;
        _animationDurationEndingViewFadeInRatio = CKPBTransitionAnimatorEndingViewFadeInDurationRatio;
        _animationDurationStartingViewFadeOutRatio = CKPBTransitionAnimatorStartingViewFadeOutDurationRatio;
        _zoomingAnimationSpringDamping = CKPBTransitionAnimatorSpringDamping;
    }
    
    return self;
}

#pragma mark - CKPBTransitionAnimator
...
+ (UIView *)newAnimationViewFromView:(UIView *)view {
    ...
    if (view.layer.contents) {
        if ([view isKindOfClass:[UIImageView class]]) {
            ...
            // See https://github.com/NYTimes/CKWebPhotoViewer/issues/115
