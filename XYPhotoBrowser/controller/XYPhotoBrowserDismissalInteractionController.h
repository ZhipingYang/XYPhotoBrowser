//
//  XYPhotoBrowserDismissalInteractionController.h
//  CKWebPhotoViewer
//
...
/**
 控制图片消失转场动画的Controller
 */
@interface XYPhotoBrowserDismissalInteractionController : NSObject <UIViewControllerInteractiveTransitioning>
