//
//  CKPhotoBrowserDismissalInteractionController.m
//  CKWebPhotoViewer
//
...
static const CGFloat CKPhotoBrowserDismissalInteractionControllerPanDismissDistanceRatio = 50.0 / 667.0; // distance over iPhone 6 height.
static const CGFloat CKPhotoBrowserDismissalInteractionControllerPanDismissMaximumDuration = 0.45;
static const CGFloat CKPhotoBrowserDismissalInteractionControllerReturnToCenterVelocityAnimationRatio = 0.00007; // Arbitrary value that looked decent.

@interface CKPhotoBrowserDismissalInteractionController ()

@property (nonatomic) id <UIViewControllerContextTransitioning> transitionContext;

@end

@implementation CKPhotoBrowserDismissalInteractionController

#pragma mark - CKPhotoBrowserDismissalInteractionController
...
- (void)finishPanWithPanGestureRecognizer:(UIPanGestureRecognizer *)panGestureRecognizer verticalDelta:(CGFloat)verticalDelta viewToPan:(UIView *)viewToPan anchorPoint:(CGPoint)anchorPoint {
    ...
    CGFloat animationDuration = (ABS(velocityY) * CKPhotoBrowserDismissalInteractionControllerReturnToCenterVelocityAnimationRatio) + 0.2;
    ...
    CGFloat dismissDistance = CKPhotoBrowserDismissalInteractionControllerPanDismissDistanceRatio * CGRectGetHeight(fromView.bounds);
    ...
    if (isDismissing) {
        if (self.shouldAnimateUsingAnimator) {
            ...
            animationDuration = MIN(animationDuration, CKPhotoBrowserDismissalInteractionControllerPanDismissMaximumDuration);
