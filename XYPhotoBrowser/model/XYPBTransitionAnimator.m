...
static const CGFloat XYPBTransitionAnimatorDurationWithZooming = 0.5;
static const CGFloat XYPBTransitionAnimatorDurationWithoutZooming = 0.3;
static const CGFloat XYPBTransitionAnimatorBackgroundFadeDurationRatio = 4.0 / 9.0;
static const CGFloat XYPBTransitionAnimatorEndingViewFadeInDurationRatio = 0.1;
static const CGFloat XYPBTransitionAnimatorStartingViewFadeOutDurationRatio = 0.05;
static const CGFloat XYPBTransitionAnimatorSpringDamping = 0.9;

@interface XYPBTransitionAnimator ()

@property (nonatomic, readonly) BOOL shouldPerformZoomingAnimation;

@end

@implementation XYPBTransitionAnimator
...
- (instancetype)init {
    ...
    if (self) {
        _animationDurationWithZooming = XYPBTransitionAnimatorDurationWithZooming;
        _animationDurationWithoutZooming = XYPBTransitionAnimatorDurationWithoutZooming;
        _animationDurationFadeRatio = XYPBTransitionAnimatorBackgroundFadeDurationRatio;
        _animationDurationEndingViewFadeInRatio = XYPBTransitionAnimatorEndingViewFadeInDurationRatio;
        _animationDurationStartingViewFadeOutRatio = XYPBTransitionAnimatorStartingViewFadeOutDurationRatio;
        _zoomingAnimationSpringDamping = XYPBTransitionAnimatorSpringDamping;
    }
    
    return self;
}

#pragma mark - XYPBTransitionAnimator
