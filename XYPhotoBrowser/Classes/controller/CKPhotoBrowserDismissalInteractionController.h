//
//  CKPhotoBrowserDismissalInteractionController.h
//  CKWebPhotoViewer
//
 ...
 */
@interface CKPhotoBrowserDismissalInteractionController : NSObject <UIViewControllerInteractiveTransitioning>
